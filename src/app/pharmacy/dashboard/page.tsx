...
const SOURCE_STYLE: Record<RxSource, string> = {
  OPD: "bg-[rgba(30,151,178,0.07)] text-[var(--color-accent)]", IPD: "bg-[rgba(30,151,178,0.07)] text-[var(--color-accent)]", ICU: "bg-red-50 text-red-700",
  OT: "bg-[rgba(30,151,178,0.07)] text-[var(--color-accent)]", "Home Rx": "bg-[rgba(30,151,178,0.07)] text-[var(--color-accent)]", Discharge: "bg-amber-50 text-amber-700",
}
const STATUS_STYLE: Record<string, string> = {
  queued: "bg-amber-100 text-amber-700", preparing: "bg-[rgba(30,151,178,0.12)] text-[var(--color-accent)]", ready: "bg-green-100 text-green-700",
}
...
export default function PharmacyOverview() {
  ...
  const KPIS = [
    ...
    { label: t("overview.kpi.onCounters"), value: m.onCounters, icon: Clock, fg: "text-[var(--color-accent)]", bg: "bg-[rgba(30,151,178,0.07)]" },
