...
export function OrdersServiceBanner({
  ...
  return (
    <div className={cn(
      ...
      paid ? "bg-green-50/60 border-green-100" : "bg-[rgba(30,151,178,0.07)]/70 border-[rgba(30,151,178,0.15)]",
    )}>
      <div className="flex items-center justify-between gap-3 mb-3">
        <div className="flex items-center gap-2.5">
          <span className={cn("h-9 w-9 rounded-2xl flex items-center justify-center flex-shrink-0", paid ? "bg-green-100 text-green-600" : "bg-[rgba(30,151,178,0.12)] text-[var(--color-accent)]")}>
        ...
        {paid ? (
          ...
          <Link href="/patient/orders" className="text-[12.5px] font-bold px-3 py-1.5 rounded-full bg-[var(--color-primary-dark)] text-white flex items-center gap-1 flex-shrink-0 active:scale-95 transition">Review & pay <ArrowRight className="h-3.5 w-3.5" /></Link>
        )}
      </div>
