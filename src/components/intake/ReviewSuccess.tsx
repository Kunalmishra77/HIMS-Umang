  ...
  useEffect(() => {
    ...
    if (voice) {
      if (lang === 'hi') {
        ...
        speak(`Thank you${first ? `, ${first}` : ''}. Your appointment is booked for ${when}, and your token number is ${token}. When you visit, please bring your Aadhaar card and the mobile number linked to it, so we can verify your identity and generate your hospital UHID. Thank you.`)
      }
      return
    }
